// src/screens/TrainingSelectionScreen.js
// Pantalla intermedia: Gimnasio o Personal
  ...
  return (
    <View style={s.container}>
      ...
      <View style={s.cards}>
        ...
        <TouchableOpacity
          style={[s.card, {
            ...
            borderColor: hasGym ? 'rgba(232,181,0,0.35)' : colors.border,
            opacity: hasGym ? 1 : 0.6,
          }]}
          onPress={() => {
            if (!hasGym) {
              navigation.navigate('JoinGym');
            } else {
              navigation.navigate('GymTraining');
            }
          }}
          activeOpacity={0.85}
        >
          <View style={[s.cardAccent, { backgroundColor: hasGym ? colors.brand : colors.border }]} />
          <View style={[s.cardIconWrap, { backgroundColor: hasGym ? 'rgba(232,181,0,0.12)' : 'rgba(136,136,136,0.1)' }]}>
          ...
          <View style={s.cardContent}>
            ...
            <Text style={[s.cardDesc, { color: colors.textSecondary }]}>
              {hasGym
                ? 'Rutinas y ejercicios de tu entrenador'
          ...
          <View style={[s.cardArrow, { backgroundColor: hasGym ? colors.brand : colors.border }]}>
        ...
        >
          ...
          <View style={s.cardContent}>
            ...
            <Text style={[s.cardDesc, { color: colors.textSecondary }]}>
              Mis ejercicios y rutinas propias
            </Text>
          </View>
      ...
      <Text style={[s.footer, { color: colors.textLight }]}>
        Seleccioná el tipo de entrenamiento
      </Text>
    </View>
  );
}
